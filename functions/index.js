...
// Draft functions moved to ./draft/draft-results.js
// - onDraftResultCreate
// - minor_onDraftResultCreate

exports.minor_onDraftResultCreate_PLACEHOLDER = onDocumentCreated(`minor_draft_results/{seasonDocId}/{resultsCollectionId}/{draftPickId}`, async (event) => {
