...
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function generateDeadlineReport() {
        ...
        if (data && data.games && data.games.length > 0) {
            ...
            const finalVerbiage = `Submit your lineup to ${recipient} OR through the website (preferred) by ${timeInput} https://www.realkarmaleague.com/gm/dashboard.html?league=${league}`;
    ...
    function generateLineupsReport(gamesData, isNoGotd) {
        ...
        const captainEmojis = { 'Penguins': ' 🐧', 'Hornets': ' 🐝', 'Vipers': ' 🐍', 'MLB': ' 👼', 'Aces': ' ♠️', 'Otters': ' 🦦', 'Demons': ' 😈', 'Hounds': ' 🐶', 'Kings': ' 👑', 'Donuts': ' 🍩', 'Tacos': ' 🌮', 'Flames': ' 🔥', 'Amigos': ' 🇲🇽', 'Heroes': ' 🦸', 'Fruit': ' 🍑', 'Goats': ' 🐐', 'Eggheads': ' 🥚', 'Crows': ' 🐦‍⬛', 'Wizards': ' 🧙‍♂️', 'Knights': ' 🤺', 'Rams': ' 🐏', 'Horses': ' 🐴' };
        const usa_diabetics = ['PJPB7G3y', 'QvDP2zgv', 'k3LgQL4v', 'rnejGZ2J', 'V3yAQ6Y3', 'Anzoj9LJ', 'BJ0VQoY3', 'wJpX8ALJ', 'kJw08M1v', 'R3XWePMv', 'R3X72zzv', '53jaEqZv'];
