...
import { auth, db, onAuthStateChanged, doc, getDoc, collection, getDocs, updateDoc, setDoc, arrayUnion, query, httpsCallable, functions } from '/js/firebase-init.js';
...
function openPlayerModal(player = null) {
    ...
    if (isEditMode) {
        ...
        dangerZone.style.display = 'block'; // Show the danger zone when editing
    } else {
        ...
        dangerZone.style.display = 'none'; // Hide it when creating a new player
    }
...
playerModal.addEventListener('click', async (e) => {
    ...
    try {
        ...
        playerModal.style.display = 'none';
        await loadAndDisplayPlayers(); // Refresh the list with updated data
