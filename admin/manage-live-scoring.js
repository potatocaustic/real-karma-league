...
const getCollectionName = (baseName) => {
    // This logic correctly handles the collections used in this script.
...
/**
 * The script's entire logic is wrapped in this event listener.
 * This is the definitive solution to prevent "element is null" errors by guaranteeing
 * that the DOM is fully loaded and parsed before any script logic attempts to find or
 * manipulate page elements.
 */
document.addEventListener('DOMContentLoaded', () => {

    // --- Page Elements (Declared safely inside the listener) ---
    ...
    function initializeControlPanel() {
        ...
        // Add all event listeners for the control buttons
    ...
    async function runFullUpdateWithProgress() {
        ...
        try {
            ...
            throw error; // Let the caller handle the alert
        } finally {
