...
import { isCommishForLeague } from '/commish/commish.js';
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    onAuthStateChanged(auth, async (user) => {
        if (user) {
            ...
            if (userDoc.exists() && (isCommishForLeague(userData, currentLeague) || userData.role === 'scorekeeper')) {
    ...
    function generateLineupsReport(gamesData, isNoGotd) {
        ...
        const captainEmojis = { 'Penguins': ' 🐧', 'Hornets': ' 🐝', 'Vipers': ' 🐍', 'MLB': ' 👼', 'Aces': ' ♠️', 'Otters': ' 🦦', 'Empire': ' 💤', 'Demons': ' 😈', 'Hounds': ' 🐶', 'Kings': ' 👑', 'Donuts': ' 🍩', 'Tacos': ' 🌮', 'Flames': ' 🔥', 'Fruit': ' 🍑', 'Goats': ' 🐐', 'Eggheads': ' 🥚', 'Crows': ' 🐦‍⬛', 'Wizards': ' 🧙‍♂️', 'Knights': ' 🤺', 'Rams': ' 🐏' };
