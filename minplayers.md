I need your help writing a script to seed my minor_v2_players collection in firestore. Here is the source data, a google sheet publichsed in csv format: https://docs.google.com/spreadsheets/d/e/2PACX-1vR2E--N7B6cD-_HWaIpxIObmDVuIxqgXhfHkf6vE1FGHeAccozSl416DtQF-lGeWUhiF_Bm-geu9yMU/pub?output=csv
1. The sheet columns, from left to right, are: player_handle, player_id, current_team_id. Row 1 is column headers. 
2. minor_v2_players should be structured exactly like v2_teams, the major league teams collection. Each player's doc ID should be their player_id. 
